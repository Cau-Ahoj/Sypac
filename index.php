        ...
        <main class="dice_page-main">
            ...
            <section class="dice_page-game">
                ...
                <div class="dice_page-game-dice">
                    <div class = "dice_page-dice"><img src="/dices/assets/kostka1b.png" alt="kostka1"></div>
                    <div class = "dice_page-dice"><img src="/dices/assets/kostka2b.png" alt="kostka1"></div>
                    <div class = "dice_page-dice"><img src="/dices/assets/kostka3b.png" alt="kostka1"></div>
                    <div class = "dice_page-dice"><img src="/dices/assets/kostka4b.png" alt="kostka1"></div>
                    <div class = "dice_page-dice"><img src="/dices/assets/kostka5b.png" alt="kostka1"></div>
                    <div class = "dice_page-dice"><img src="/dices/assets/kostka6b.png" alt="kostka1"></div>
                </div>
