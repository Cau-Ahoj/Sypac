        ...
        <main class = "register_page-main">
            <article>
                ...
                <form action= "validateReg.php" class ="register_page-form" method="post">
                    ...
                    <label for="password_confirm" class="register_page-label">Repeat password</label>
                    <input type="password" name="password_confirm" class ="register_page-input" required>

                    <p class ="register_page-note">Already have an account? <br>
                        <a href="../login/login.php" class="register_page-link">Login</a>
                    </p>
